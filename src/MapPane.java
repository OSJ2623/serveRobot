...
//        System.out.println("dd" + x1 + y1);
    ...
    public void setRobot(int robot, int[][] position, int[] dest) { //목적지 정보
    	this.robot = robot;
...
//    	g.drawImage(map, 0, 0, 600, 580, this);
	...
	public void actionPerformed(ActionEvent e) {
		...
		y = y+yVel;
		*/
//    	System.out.println("마지막: "+ temp1[0] + "," + temp1[1]);
...
//    	System.out.println(p1);
		...
		if(p1 != null) {
//			System.out.println("가는x: " + p1.x + ", 현재x: " + (x1+robot_front1.getWidth(null)/2)
//			+ ",가는 y: " + p1.y +", 현재 y: " +(y1+robot_front1.getHeight(null)/2));
			
			if(p1.x != (x1+robot_front1.getWidth(null)/2)) { //만약 현재 위치가 x좌표와 같지 않다면
				flag1 = 1;
...
//			System.out.println("가는x: " + p2.x + ", 현재x: " + (x2+robot_front1.getWidth(null)/2)
//			+ ",가는 y: " + p2.y +", 현재 y: " +(y2+robot_front1.getHeight(null)/2));
			
			if(p2.x != (x2+robot_front1.getWidth(null)/2)) { //만약 현재 위치가 x좌표와 같지 않다면
				flag2 = 1;
